...
export const getNavLinks = (t: TFunction): NavLink[] => [
  ...
  { label: t('nav.messaging'), path: '/messaging', icon: ICONS.messaging },
  { label: t('nav.orders'),    path: '/orders',   icon: ICONS.orders },
  { label: t('nav.dashboard'), path: '/Admin',    icon: ICONS.dashboard },
  { label: t('nav.profile'),   path: '/Profile',  icon: ICONS.profile },
]

export const getAuthLinks = (t: TFunction): NavLink[] => [
  { label: t('nav.login'),  path: '/signin', icon: ICONS.login },
  { label: t('nav.signup'), path: '/signup', icon: ICONS.signup },
]
